  ...
  return {
    ...
    providers: {
      ...
      anthropic: {
        ...
        models: [
          { id: "claude-sonnet-4-6-20250627", label: "Sonnet 4.6", tier: "standard", costTier: "medium", contextWindow: 200000 },
          { id: "claude-opus-4-6-20250627", label: "Opus 4.6", tier: "powerful", costTier: "high", contextWindow: 200000 },
      ...
      openai: {
        ...
        label: "OpenAI",
        models: [
          { id: "gpt-5.4", label: "GPT-5.4", tier: "powerful", costTier: "high", contextWindow: 200000 },
          { id: "gpt-4o", label: "GPT-4o", tier: "standard", costTier: "medium", contextWindow: 128000 },
          ...
          { id: "o4-mini", label: "o4-mini", tier: "standard", costTier: "medium", contextWindow: 200000 },
        ],
        enabled: true,
      },
      gemini: {
        ...
        label: "Google Gemini",
        models: [
          { id: "gemini-3.1-flash", label: "Gemini 3.1 Flash", tier: "standard", costTier: "medium", contextWindow: 1000000 },
          { id: "gemini-3.1-pro", label: "Gemini 3.1 Pro", tier: "powerful", costTier: "high", contextWindow: 1000000 },
