...
import type { LayerState, LayerSnapshot, CompactionPlan, CompactionLLMProvider } from "@inixiative/foundry-core";
import {
  TrustBasedStrategy,
  LRUStrategy,
  SummarizeStrategy,
  HybridStrategy,
} from "../src/agents/compaction-strategies";

type LLMProvider = CompactionLLMProvider;
